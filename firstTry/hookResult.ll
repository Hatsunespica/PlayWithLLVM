...
@.str.3 = private unnamed_addr constant [19 x i8] c"test for a hook%d\0A\00", align 1
...
define void @_Z10__initMaini(i32) #2 {
  %2 = alloca i32, align 4
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.3, i32 0, i32 0), i32 %3)
  ret void
}
